...
public class FragmentViewModel extends AndroidViewModel {
    ...
    private static final double MOSCOW_LATITUDE = 55.753913;
    private static final double MOSCOW_LONGITUDE = 37.620836;
    ...
    public void getWeather(String apiKey, int index) {
        double latitude;
        double longitude;
        if (index == 0) {
        ...
        service.getDailyWeather(apiKey, latitude, longitude)
